const CACHE="barford-golf-2027-fresh-ui-v15";
const CORE=[
  "./","./index.html","./events.html","./scoring.html",
  "./assets/css/styles.css","./assets/css/members.css","./assets/css/accessible-mobile.css","./assets/css/product-premium.css","./assets/css/product-polish.css","./assets/css/product-polish-mobile.css","./assets/css/brilliant.css","./assets/css/mobile-redesign.css","./assets/css/events.css","./assets/css/scoring.css","./assets/css/scoring-simple.css","./assets/css/score-competitions.css",
  "./assets/js/app.js","./assets/js/events-live.js","./assets/js/product-experience.js","./assets/js/admin-scorecard-preview.js","./assets/js/scoring.js","./assets/js/scoring-resilience.js","./assets/js/supabase-config.js","./assets/js/supabase-client.js",
...
self.addEventListener("fetch",event=>{
  ...
  const isFreshUiAsset=/\/assets\/js\/(app|events-live|product-experience|admin-auth|admin-scoring|admin-scorecard-preview|admin-brilliant|event-course-setup|test-event-controls)\.js$/.test(path)||/\/assets\/css\/(mobile-redesign|events)\.css$/.test(path);
  if(request.mode==="navigate"){
    event.respondWith((async()=>{const cache=await caches.open(CACHE);return networkFirst(cache,request,"./index.html")})());return;
  }
