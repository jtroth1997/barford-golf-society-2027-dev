const CACHE_NAME = "barford-golf-demo-today-v1";
const CORE = [
  ...
  "./assets/css/styles.css?v=fast3","./assets/css/accessible-mobile.css?v=mobile4","./assets/css/events.css","./assets/css/tee-organiser.css","./assets/css/scores.css?v=7","./assets/css/mobile-menu-fix.css?v=1","./assets/css/members.css","./assets/css/gallery.css","./assets/css/admin.css","./assets/css/payment-beta.css?v=3","./assets/css/payment-beta-shared.css?v=beta4",
  "./assets/js/app.js?v=mobile4","./assets/js/accessible-mobile.js?v=mobile4","./assets/js/demo-today.js?v=2","./assets/js/member-session.js","./assets/js/event-countdown.js","./assets/js/event-weather.js","./assets/js/event-camera.js","./assets/js/admin.js","./assets/js/scores.js?v=7","./assets/js/scores-data.js","./assets/js/handicap-engine.js","./assets/js/payment-beta.js?v=4","./assets/js/payment-beta-shared.js?v=beta11",
