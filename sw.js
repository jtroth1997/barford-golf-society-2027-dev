...
const CORE = [
  ...
  "./assets/js/app.js?v=rapid16","./assets/js/accessible-mobile.js?v=rapid2","./assets/js/member-session.js","./assets/js/event-countdown.js","./assets/js/event-weather.js","./assets/js/event-camera.js","./assets/js/admin.js","./assets/js/scores.js?v=7","./assets/js/scores-data.js","./assets/js/handicap-engine.js","./assets/js/payment-beta.js?v=4","./assets/js/payment-beta-shared.js?v=beta11",
