const CACHE = "barford-golf-2027-product-v2";
const CORE = [
  "./",
  "./index.html",
  "./events.html",
  ...
  "./assets/css/product-premium.css?v=1",
  ...
  "./assets/css/members.css?v=simpleflow1",
  "./assets/css/members.css?v=eventcamera1",
  ...
  "./assets/css/accessible-mobile.css?v=simplenav1",
  "./assets/css/events.css?v=video1",
  "./assets/css/events.css?v=rsvpmanage1",
  "./assets/css/events.css?v=simplechoice1",
  "./assets/css/scores.css?v=league6",
  "./assets/css/scores.css?v=preseason1",
  ...
  "./assets/css/scoring-simple.css?v=1",
  ...
  "./assets/css/admin-scoring-results.css?v=checklist1",
  "./assets/css/score-competitions.css?v=1",
  "./assets/js/app.js?v=profilephoto2",
  "./assets/js/app.js?v=speed2",
  "./assets/js/product-experience.js?v=1",
  "./assets/js/event-day-camera.js?v=1",
  "./assets/js/member-dashboard.js?v=rsvp1",
  "./assets/js/member-dashboard.js?v=teeclick2",
  "./assets/js/member-dashboard.js?v=cancel1",
  "./assets/js/member-dashboard.js?v=simple1",
  "./assets/js/member-dashboard.js?v=simple2",
  "./assets/js/member-dashboard.js?v=simplewords1",
  "./assets/js/member-auth.js?v=account5",
  "./assets/js/member-auth.js?v=ux100",
  "./assets/js/member-auth.js?v=course-tees1",
  "./assets/js/member-auth.js?v=course-tees2",
  ...
  "./assets/js/admin-scoring.js?v=checklist1",
  "./assets/js/events-live.js?v=video1",
  "./assets/js/events-live.js?v=rsvpmanage1",
  "./assets/js/events-live.js?v=simplechoice1",
  "./assets/js/scores.js?v=league6",
  "./assets/js/scores.js?v=preseason1",
  ...
  "./assets/js/scoring.js?v=trust3",
  "./assets/js/scoring.js?v=cardreview1",
  ...
  "./assets/js/accessible-mobile.js?v=simplenav1",
