...
-- Confirmed players can see the names of other confirmed players for the same
-- event. Private contact and account details are deliberately not returned.
...
-- Member RSVP choices lock as soon as tee times are saved. Administrators can
-- still make a case-by-case change.
